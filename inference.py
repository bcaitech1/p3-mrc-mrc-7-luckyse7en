...
from utils_qa import clean_example, clean_text, postprocess_qa_predictions, check_no_error, tokenize
...
def main():
    ...
    training_args.output_dir = f'{training_args.output_dir}{retrieval_args.retrieval_algorithm}/topk_{retrieval_args.topk}/'
    ...
    if data_args.eval_retrieval:
        datasets = run_sparse_retrieval(tokenizer.tokenize, datasets, training_args, retrieval_args, topk=retrieval_args.topk)
...
def run_sparse_retrieval(tokenize, datasets, training_args, retrieval_args, topk=1):
    #### retreival process ####
    ...
    df = retriever.retrieve(datasets['validation'], topk=topk, algorithm=retrieval_args.retrieval_algorithm)
